...
class Hero extends Component {
    ...
    template() {
        return `
            <section class="slice slice-xl pb-250 d-none d-md-block bg-gradient-secondary" 
                ...
                <div class="spotlight-holder d-flex align-items-center">
                    <div class="container position-relative zindex-100 py-4 py-md-7">
                        <div class="col">
                            <div class="row align-items-center justify-content-around">
                                <div class="col-lg-6 text-center text-lg-left">
                                    <h1>I am ${this.data.name}, a ${this.data.title}</h1>
                                    <p class="lead mt-4">${this.data.description}</p>
                                    
                                    <div class="w-75">
                                        <div class="mt-5 d-flex justify-content-between mb-3">
                                            <a href="${this.data.social.github}" 
                                               class="btn btn-dark btn-icon rounded-pill hover-translate-y-n3"
                                               target="_blank"
                                            ...
                                            <a href="${this.data.social.linkedin}" 
                                               class="btn btn-outline-dark rounded-pill hover-translate-y-n3 d-none d-lg-inline-block"
                                               target="_blank"
                                               rel="noopener noreferrer"
                                               aria-label="Visit LinkedIn profile">
                                                <span class="btn-inner--icon"><i class="fab fa-linkedin-in" aria-hidden="true"></i></span>
                                                <span class="btn-inner--text">LinkedIn</span>
                                            </a>
                                        </div>
                                        <div>
                                            <a href="${this.data.resume}" 
                                               target="_blank"
                                               class="btn btn-white btn-block rounded-pill"
                                               rel="noopener noreferrer"
                                               aria-label="Download resume (PDF)">
                                                <span class="btn-inner--text">Resume</span>
                                                <span class="btn-inner--icon"><i class="fas fa-download" aria-hidden="true"></i></span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 mt-7 order-lg-2 mt-lg-0 align-self-end">
                                    <img alt="${this.data.name} - ${this.data.title}" 
                ...
                <div class="shape-container" data-shape-position="bottom" style="height: 185.484px;" aria-hidden="true">
    ...
    getBackgroundSVG() {
        return `
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1506.3 578.7" class="injected-svg svg-inject" aria-hidden="true">
                ...
                <path class="fill-yellow" d="M 330.588 185.515 C 331.035 184.361 332.064 183.533 333.286 183.344 L 344.736 181.565 C 345.958 181.374 347.189 181.852 347.965 182.815 L 355.23 191.841 C 356.006 192.805 356.209 194.11 355.762 195.264 L 351.578 206.068 C 351.131 207.222 350.102 208.05 348.88 208.24 L 337.43 210.019 C 336.208 210.209 334.977 209.732 334.201 208.768 L 326.936 199.742 C 326.16 198.778 325.957 197.474 326.404 196.32 L 330.588 185.515 Z"></path>
