		...
		return `
            <div id="headers-header-4" class="d-md-none" aria-label="Mobile introduction">
                <section class="spotlight pt-5 bg-cover bg-size--cover" 
                    ...
                    <!-- Purple gradient overlay - starts from TOP of the section -->
                    <span class="mask bg-gradient-primary opacity-6" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1;"></span>
                    
                    <!-- Spotlight content overlay - above the mask -->
                    <div class="spotlight-holder pt-7 pb-7 py-lg-0" style="height: auto; position: relative; z-index: 5;">
                        <div class="container d-flex align-items-center">
                            <div class="col">
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-md-9 col-lg-7 text-left">
                                        <span class="badge badge-soft-warning badge-pill mb-3">
                    ...
                    <!-- Wave shape at absolute bottom -->
                    <div class="shape-container mb-n2 h-auto" data-shape-position="bottom" style="z-index: 3;" aria-hidden="true">
